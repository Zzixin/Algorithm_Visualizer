...
async function displayAnimations(bars, index1, index2) {
    bars[index1].style.backgroundColor = '#ffff00';
    bars[index2].style.backgroundColor = '#ffff00';
    await new Promise(r => setTimeout(r, 16));
    bars[index1].style.backgroundColor = '#00b300';
    bars[index2].style.backgroundColor = '#00b300';
}